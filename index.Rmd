---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en el cantón de La Unión"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/launion/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_LA_UNION_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_migratorias_la_union/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_migratorias_la_union/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.004527, 0.016699, 0.149749, 0.249210, Inf)
...
# Importancia
bins_importancia <- c(0, 1465773797250.00, 6411280869840.00, 13501623029900.00, 134712877812000.00, Inf)
